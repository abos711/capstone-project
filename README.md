...
This template contains a project, `django_auth_capstone`, and an app, `api`,
...
1. Replace all instances of `django_auth_capstone` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `django_auth_capstone` which should be renamed
...
all instances of `django_auth_capstone` with your app's name.
